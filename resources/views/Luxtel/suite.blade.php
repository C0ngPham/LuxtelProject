...
<body>
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          ...
          <div class="media d-block room mb-0">
            <figure>
              <img src="images/Suite/Suite.jpg" alt="Generic placeholder image" class="img-fluid" />
            ...
            <div class="media-body">
              <h3 class="mt-0"><a href="#">SUITE</a></h3>
              <ul class="room-specs">
                <li>
                  <span class="ion-ios-people-outline"></span> Max 16 Guests
                </li>
                <li><span class="ion-ios-crop"></span> 70 m <sup>2</sup></li>
              </ul>
              <p>
                King-sized bed
              </p>
              ...
              <p>
                49-inch flat-screen TV with international channels
              </p>
              <p>
                Marble bathroom with bathtub and walk-in shower
              </p>
              <p>
  ...
  <section class="section-cover" style="
        background-image: url(images/Suite/Suite.jpg);
        height: 800px;
        margin: 20px;
      "></section>
  <!-- END section -->
  ...
  <section class="section-cover" style="
        background-image: url(images/Suite/Suite1.jpg);
        height: 800px;
        margin: 20px;
      "></section>
  <!-- END section -->
  ...
  <section class="section-cover" style="
        background-image: url(images/Suite/Suite2.jpg);
        height: 800px;
        margin: 20px;
      "></section>
  <!-- END section -->
  ...
  <section class="section-cover" style="
        background-image: url(images/Suite/Suite3.jpg);
        height: 800px;
        margin: 20px;
      "></section>
  <!-- END section -->
  ...
  <section class="section-cover" style="
        background-image: url(images/Suite/Suite4.jpg);
        height: 800px;
        margin: 20px;
      "></section>
  <!-- END section -->
  ...
  <section class="section-cover" style="
        background-image: url(images/Suite/Suite5.jpg);
        height: 800px;
        margin: 20px;
      "></section>
  <!-- END section -->
  ...
  <section class="section-cover" style="
        background-image: url(images/Suite/Suite6.jpg);
        height: 800px;
        margin: 20px;
      "></section>
  <!-- END section -->
...
<script>
  ...
  var range = vdpt - varr;
  var vprice = 300*vroom + 100*vguest;
  ...
  if (isNaN(range)){
    ...
    if (m_vdpt > m_varr ){
      ...
      if (range > 30|| mrange > 1 ){
        ...
        if (vguest <= vroom*4) {
          vprice = 300*vroom*range ;
        } else {
          vprice = (300*vroom + 100*vguest - 100*4*vroom)*range;
        }
